...
func resourcePostgreSQLRoleParameter() *schema.Resource {
	return &schema.Resource{
		Create: PGResourceFunc(resourcePostgreSQLRoleParameterCreate),
		Read:   PGResourceFunc(resourcePostgreSQLRoleParameterRead),
		Delete: PGResourceFunc(resourcePostgreSQLRoleParameterDelete),
...
func resourcePostgreSQLRoleParameterRead(db *DBConnection, d *schema.ResourceData) error {
...
func resourcePostgreSQLRoleParameterCreate(db *DBConnection, d *schema.ResourceData) error {
	if !db.featureSupported(featurePrivileges) {
		return fmt.Errorf(
			"postgresql_alter_role resource is not supported for this Postgres version (%s)",
			db.version,
...
func resourcePostgreSQLRoleParameterDelete(db *DBConnection, d *schema.ResourceData) error {
	if !db.featureSupported(featurePrivileges) {
		return fmt.Errorf(
			"postgresql_alter_role resource is not supported for this Postgres version (%s)",
			db.version,
